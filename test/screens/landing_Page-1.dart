...
void main() {
  group('LandingPage Widget Tests', () {
    ...
    testWidgets('Test Get Started button tap', (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(home: const Scaffold(), navigatorObservers: [mockNavigatorObserver]));

      await tester.tap(find.text('Get Started'));
      await tester.pumpAndSettle();

      Route<dynamic> dummyRoute = MaterialPageRoute(builder: (_) => Container());
      Route<dynamic>? dummyPreviousRoute;

      // Verify using the dummy objects
      verify(mockNavigatorObserver.didPush(dummyRoute, dummyPreviousRoute));
